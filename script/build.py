...
def gen(platform):
    print("-------gen start -------\n")
    command = command = "cmake -DCMAKE_MAKE_PROGRAM=/usr/bin/make -S" + root_path + " -B " + build_path + " -G "
    if platform == "iOS":
...
def set_setting():    
    ...
    parser.add_argument('-p', '--platform',
                        action='store', 
                        help=""" build platform, "base" type is macOS or linux, only test base and core library, default = "base" """, 
                        default="base", 
    ...
    parser.add_argument('-n', '--component',
                        action='store',
                        help= """ component: base, core defaul = base """, 
                        default="base",
                        choices=["base", "core"],
                        metavar= "base")
