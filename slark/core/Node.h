...
public:
    ...
    virtual void receive(std::shared_ptr<AVFrame> frame) noexcept = 0;
};
...
public:
    ...
    virtual void send(std::shared_ptr<AVFrame> frame) noexcept;
...
public:
    ...
    void receive(std::shared_ptr<AVFrame> frame) noexcept override;
